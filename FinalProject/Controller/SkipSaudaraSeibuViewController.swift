//
//  SkipSaudaraSeibuViewController.swift
//  FinalProject
//
...
class SkipSaudaraSeibuViewController: UIViewController {
    ...
    @IBAction func buttonNextPressed(_ sender: Any) {
        if isAshabah{
            performSegue(withIdentifier: "toEndFromSkipSaudaraSeibu", sender: nil)
        } else {
            performSegue(withIdentifier: "toAnakSaudaraFromSkipSaudaraSeibu", sender: nil)
        }
    }
}
